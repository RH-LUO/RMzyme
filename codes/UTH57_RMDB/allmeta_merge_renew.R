...
# allmeta_files <- allmeta_files[grepl('GSE148673|GSE163203|GSE181254|PRJCA001063',allmeta_files)]
...
# saveRDS(sc_majortype, file = '/data2/rluo4/RPMfunc/Output/scRNA/sc_majortype_1022.rds') # combined with diff meta from merge_nmf_meta and allmeta
...
barcode_idx[idx9] <- str_split(barcode_idx[idx9], '[...]', simplify = T)[, 1]
...
saveRDS(sc_allmeta, file = '/data2/rluo4/RPMfunc/Output/scRNA/sc_allmeta.rds')
...
saveRDS(sc_allmeta, file = '/data2/rluo4/RPMfunc/Output/scRNA/sc_allmeta_1122.rds')
